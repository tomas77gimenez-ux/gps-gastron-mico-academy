          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            {user ? (
              <button
                ...
                className="hidden min-[1100px]:flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm text-muted-foreground hover:text-foreground bg-nav-control/60 hover:bg-nav-control transition-colors"
            ...
            <button
              ...
              className="min-[1100px]:hidden p-2 rounded-lg text-muted-foreground hover:text-foreground bg-nav-control/60 hover:bg-nav-control transition-colors"
            >
