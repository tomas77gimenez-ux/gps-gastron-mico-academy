...
const translations = {
  ...
  "planes.planActual": { es: "Tu plan actual", en: "Your current plan" },
  "planes.gestionar": { es: "Gestionar suscripción", en: "Manage subscription" },
  "planes.gestionarDesc": { es: "Cambiá de plan, actualizá tu método de pago o cancelá cuando quieras.", en: "Change plan, update payment method or cancel anytime." },
  "planes.equivalente": { es: "facturado anualmente", en: "billed annually" },
  "planes.ahorra": { es: "Ahorrás", en: "You save" },
  "planes.alAno": { es: "/año", en: "/yr" },
  "planes.compararTitulo": { es: "Compará los planes en detalle", en: "Compare plans in detail" },
  "planes.feature": { es: "Característica", en: "Feature" },
  "planes.faqTitulo": { es: "Preguntas frecuentes sobre planes", en: "Frequently asked questions about plans" },
  "planes.faqQ1": { es: "¿Puedo cancelar cuando quiera?", en: "Can I cancel anytime?" },
  "planes.faqA1": { es: "Sí. Podés cancelar tu suscripción en cualquier momento desde 'Gestionar suscripción'. Mantenés el acceso hasta el final del período pagado.", en: "Yes. You can cancel your subscription anytime from 'Manage subscription'. You keep access until the end of the paid period." },
  "planes.faqQ2": { es: "¿Puedo cambiar de Básico a Premium?", en: "Can I switch from Basic to Premium?" },
  "planes.faqA2": { es: "Sí, podés hacer upgrade o downgrade cuando quieras. La diferencia se prorratea automáticamente.", en: "Yes, you can upgrade or downgrade anytime. The difference is prorated automatically." },
  "planes.faqQ3": { es: "¿Qué métodos de pago aceptan?", en: "What payment methods do you accept?" },
  "planes.faqA3": { es: "Aceptamos todas las tarjetas de crédito y débito principales (Visa, Mastercard, American Express) a través de Stripe.", en: "We accept all major credit and debit cards (Visa, Mastercard, American Express) through Stripe." },
  "planes.faqQ4": { es: "¿Hay garantía de reembolso?", en: "Is there a money-back guarantee?" },
  "planes.faqA4": { es: "Ofrecemos 7 días de garantía. Si no estás conforme, te devolvemos el 100% de lo pagado, sin preguntas.", en: "We offer a 7-day guarantee. If you're not satisfied, we refund 100% with no questions asked." },
  "planes.faqQ5": { es: "¿La factura anual incluye los 12 meses de una vez?", en: "Does the annual invoice cover all 12 months at once?" },
  "planes.faqA5": { es: "Sí. Pagás una sola vez por todo el año y obtenés un 20% de descuento sobre el precio mensual.", en: "Yes. You pay once for the whole year and get a 20% discount over the monthly price." },
  "planes.garantia": { es: "Garantía de 7 días — devolvemos el 100% si no estás conforme", en: "7-day guarantee — 100% refund if you're not satisfied" },
  "planes.pagoSeguro": { es: "Pago seguro vía Stripe", en: "Secure payment via Stripe" },

  "compare.cursos": { es: "Acceso a todos los cursos", en: "Access to all courses" },
  "compare.dre": { es: "Planillas DRE y SUP", en: "DRE & SUP spreadsheets" },
  "compare.foodcost": { es: "Calculadora de Food Cost", en: "Food Cost Calculator" },
  "compare.asistente": { es: "Asistente IA gastronómico", en: "Gastronomic AI Assistant" },
  "compare.comunidad": { es: "Comunidad privada", en: "Private community" },
  "compare.mentoria": { es: "Mentoría grupal mensual", en: "Monthly group mentorship" },
  "compare.individual": { es: "Acceso prioritario a mentorías 1:1", en: "Priority access to 1:1 mentorship" },
  "compare.whatsapp": { es: "Soporte directo por WhatsApp", en: "Direct WhatsApp support" },
  "compare.descuentos": { es: "Descuentos en la tienda", en: "Store discounts" },
  "compare.contenido": { es: "Contenido exclusivo avanzado", en: "Exclusive advanced content" },
  "compare.actualizaciones": { es: "Actualizaciones mensuales", en: "Monthly updates" },
  ...
  "home.plans.perYear": { es: "/año", en: "/yr" },
  "home.plans.billingMonthly": { es: "Mensual", en: "Monthly" },
  "home.plans.billingYearly": { es: "Anual", en: "Yearly" },
  "home.plans.save20": { es: "Ahorra 20%", en: "Save 20%" },
