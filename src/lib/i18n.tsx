...
const translations = {
  ...
  "planes.faqQ2": { es: "¿Puedo cambiar de Básico a Premium?", en: "Can I switch from Basic to Premium?", pt: "Posso mudar do Básico para o Premium?" },
  ...
  "perfil.gestionar": { es: "Gestionar suscripción", en: "Manage subscription", pt: "Gerenciar assinatura" },
  ...
  "home.plans.basicName": { es: "Plan Básico", en: "Basic Plan", pt: "Plano Básico" },
  ...
  "home.plans.basicF1": { es: "Acceso a todos los cursos", en: "Access to all courses", pt: "Acesso a todos os cursos" },
  "home.plans.basicF2": { es: "Planillas DRE y SUP", en: "DRE & SUP spreadsheets", pt: "Planilhas DRE e SUP" },
  "home.plans.basicF3": { es: "Calculadora de Food Cost", en: "Food Cost Calculator", pt: "Calculadora de Food Cost" },
  "home.plans.basicF4": { es: "Comunidad privada", en: "Private community", pt: "Comunidade privada" },

  "home.plans.premiumName": { es: "Plan Premium", en: "Premium Plan", pt: "Plano Premium" },
  "home.plans.premiumDesc": { es: "Resultados acelerados con acompañamiento directo.", en: "Accelerated results with direct guidance.", pt: "Resultados acelerados com acompanhamento direto." },
  "home.plans.premiumF1": { es: "Todo del Plan Básico", en: "Everything in Basic Plan", pt: "Tudo do Plano Básico" },
  "home.plans.premiumF2": { es: "Mentoría grupal mensual", en: "Monthly group mentorship", pt: "Mentoria em grupo mensal" },
  "home.plans.premiumF3": { es: "Soporte por WhatsApp", en: "WhatsApp support", pt: "Suporte por WhatsApp" },
  "home.plans.premiumF4": { es: "Descuentos en la tienda", en: "Store discounts", pt: "Descontos na loja" },
} as const;
