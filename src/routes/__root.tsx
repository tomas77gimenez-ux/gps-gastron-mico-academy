...
export const Route = createRootRoute({
  ...
  head: ({ loaderData }) => {
    const t = tFor(loaderData?.lang ?? readPrefs().lang);
    return {
    meta: [
      { charSet: "utf-8" },
      ...
      { title: t("root.headTitle") },
      { name: "description", content: t("root.headDesc") },
      { name: "author", content: "GPS Gastronômico" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "GPS Gastronômico" },
      { property: "og:locale", content: "es_ES" },
      { name: "twitter:card", content: "summary" },
      { property: "og:title", content: t("root.headTitle") },
      { name: "twitter:title", content: t("root.headTitle") },
      { property: "og:description", content: t("root.headDesc") },
      { name: "twitter:description", content: t("root.headDesc") },
    ],
    links: [
      {
        rel: "stylesheet",
