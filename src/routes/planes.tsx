...
const plans = [
  {
    ...
    description: { es: "Todas las herramientas y las clases de la mentoría, excepto la planilla SUP.", en: "All tools and mentorship classes, except the SUP spreadsheet." },
    icon: Star,
    featured: false,
    features: {
      es: [
        "Acceso a las clases de la mentoría",
        "Todas las herramientas de gestión (DRE, Punto de Equilibrio, Control de Caja, Monitor de CMV)",
        "Asistente IA gastronómico",
        "Actualizaciones mensuales",
        "Sin acceso a la planilla SUP",
      ],
      en: [
        "Access to mentorship classes",
        "All management tools (DRE, Break-even, Cash Control, CMV Monitor)",
        "Gastronomic AI assistant",
        "Monthly updates",
        "SUP spreadsheet not included",
      ],
    },
  },
  {
    ...
    description: { es: "Acceso total: todas las clases, todas las herramientas y acompañamiento diario.", en: "Full access: all classes, all tools and daily guidance." },
    icon: Crown,
    featured: true,
    features: {
      es: [
        "Acceso a todas las clases",
        "Todas las herramientas, incluida la planilla SUP",
        "Grupo VIP de WhatsApp con otros miembros premium",
        "Soporte diario del equipo de Daniel",
        "Asistente IA gastronómico",
      ],
      en: [
        "Access to all classes",
        "All tools, including the SUP spreadsheet",
        "VIP WhatsApp group with other premium members",
        "Daily support from Daniel's team",
        "Gastronomic AI assistant",
      ],
    },
  },
...
const compareFeatures = [
  { key: "compare.clases", basico: true, premium: true },
  ...
  { key: "compare.sup", basico: false, premium: true },
  { key: "compare.vip", basico: false, premium: true },
  { key: "compare.soporte", basico: false, premium: true },
] as const;
