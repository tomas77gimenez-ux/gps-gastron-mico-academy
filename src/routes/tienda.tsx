...
const products: Product[] = [
  {
    ...
    description: "BRANDING, REDES SOCIALES, HERRAMIENTAS CON I.A. Agende una reunión para hablar con nuestra agencia de marketing sobre tu negocio.",
    descEn: "BRANDING, SOCIAL MEDIA, AI TOOLS. Schedule a meeting to talk with our marketing agency about your business.",
    icon: Megaphone,
    priceId: null,
  ...
  },
  {
    ...
    description: "Herramienta que te ayuda a entender los números de tu Instagram y decidir tu estrategia para que tu cuenta crezca de forma orgánica.",
    descEn: "Tool that helps you understand your Instagram numbers and decide your strategy so your account grows organically.",
    icon: LineChart,
  ...
  },
  {
    ...
    title: "Rebranding",
    titleEn: "Rebranding",
    description: "Paquete de rebranding para tu restaurante: menú nuevo, website nuevo con pedidos online, logotipo y manual de marca, aplicaciones de marca en materiales.",
    descEn: "Rebranding package for your restaurant: new menu, new website with online ordering, logo and brand manual, brand applications in materials.",
    icon: Palette,
